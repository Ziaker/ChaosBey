...
export function createLandingBurst(magnitude: number, positionM: WorldPositionM): ActiveLandingBurst {
  ...
  const material = new THREE.MeshBasicMaterial({ color: LANDING_RING_COLOR_HEX, transparent: true, opacity: 0.8, side: THREE.DoubleSide, depthWrite: false });
